...
export const qaData = {
  ...
  5: {
    question: [
      "尊敬的冒险者",
      { text: `恭喜你披星戴月到达这里, 终点就在你面前⚡` },
      { text: `⏳ 距离惊喜揭晓，只剩 1 个正确答案的距离！` },
      { text: `解开它吧🔍，期待与你见面！` },
      "规律:",
      { text: `131.121.321.132=DATE`, tips: "可以看看你手机的九键输入法看看对应的字母都有什么规则" },
      "请问",
      { text: `223.233.323.132=???`},
    ],
    placeholder: "请输入4个字母,规则在九键输入法键盘",
    answer: "LOVE",
    thread: [
      {
        type: "text",
