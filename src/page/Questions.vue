                ...
                <div class="as_item" v-for="(item, index) in qaInfo.thread" :key="index">
                    ...
                    <div class="img_view" v-if="item.type === 'img'">
                        <template v-if="item.content">
                            ...
                            <el-image-viewer v-if="showPreview" :url-list="item?.imgList || [item.url]" show-progress
                                @close="showPreview = false" />
                        </template>
                        <template v-else>
                            <el-image :src="item.url" :preview-src-list="item?.imgList || [item.url]" show-progress />
                        </template>
                    </div>
